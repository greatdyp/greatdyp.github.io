/* Packaged by Dandy Weng at 2015/10/05 04:35Z. */
/* http://www.dandyweng.com/ */

/* class helper functions https://github.com/ded/bonzo */
! function (a) {
    "use strict";
    ...
    "classList" in document.documentElement ? (c = function (a, b) {
        ...
        remove: e,
        toggle: f
    }, "function" == typeof define && define.amd ? define(g) : "object" == typeof exports ? module.exports = g : a.dw = g
}(window);
...
! function (a, b) {
    ...
    function e(a, c, e) {
        var f;
        return f = "translate3d" === b.positionUsing ? {
            transform: "translate3d(" + d(a) + "%,0,0)"
        } : "translate" === b.positionUsing ? {
            transform: "translate(" + d(a) + "%,0)"
        } : {
            "margin-left": d(a) + "%"
        }, f.transition = "all " + c + "ms " + e, f
    }

    function h(a, b) {
        var c = "string" == typeof a ? a : k(a);
    ...
    function i(a, b) {
        var c = k(a),
            d = c + b;
        h(c, b) || (a.className = d.substring(1))
    }

    function j(a, b) {
        var d, c = k(a);
        h(a, b) && (d = c.replace(" " + b + " ", " "), a.className = d.substring(1, d.length - 1))
    }
    ...
    var b, f, g, a = {};
    return a.version = "0.1.6", b = a.settings = {
            minimum: .08,
            easing: "ease",
            positionUsing: "",
            speed: 200,
            ...
            return this
        }, a.status = null, a.set = function (d) {
            var i, j, k, l, h = a.isStarted();
            return d = c(d, b.minimum, 1), a.status = 1 === d ? null : d, i = a.render(!h), j = i.querySelector(b.barSelector), k = b.speed, l = b.easing, i.offsetWidth, f(function (c) {
                "" === b.positionUsing && (b.positionUsing = a.getPositioningCSS()), g(j, e(d, k, l)), 1 === d ? (g(i, {
                    transition: "none",
                    opacity: 1
            ...
            var c = function () {
                setTimeout(function () {
                    a.status && (a.trickle(), c())
                }, b.trickleSpeed)
            };
            return b.trickle && c(), this
        }, a.done = function (b) {
            return b || a.status ? a.inc(.3 + .5 * Math.random()).set(1) : this
        }, a.inc = function (b) {
            var d = a.status;
            return d ? ("number" != typeof b && (b = (1 - d) * c(Math.random() * d, .1, .95)), d = c(d + b, 0, .994), a.set(d)) : a.start()
        }, a.trickle = function () {
            return a.inc(Math.random() * b.trickleRate)
        },
        function () {
            var b = 0,
                c = 0;
            ...
            var e, k, f, h, j;
            return a.isRendered() ? document.getElementById("nprogress") : (i(document.documentElement, "nprogress-busy"), e = document.createElement("div"), e.id = "nprogress", e.innerHTML = b.template, f = e.querySelector(b.barSelector), h = c ? "-100" : d(a.status || 0), j = document.querySelector(b.parent), g(f, {
                transition: "all 0 linear",
                transform: "translate3d(" + h + "%,0,0)"
            }), b.showSpinner || (k = e.querySelector(b.spinnerSelector), k && l(k)), j != document.body && i(j, "nprogress-custom-parent"), j.appendChild(e), e)
        }, a.remove = function () {
            j(document.documentElement, "nprogress-busy"), j(document.querySelector(b.parent), "nprogress-custom-parent");
            ...
            function d(b) {
                var f, d, e, c = document.body.style;
                if (b in c) return b;
                for (d = a.length, e = b.charAt(0).toUpperCase() + b.slice(1); d--;)
                    if (f = a[d] + e, f in c) return f;
                return b
            }

            function e(a) {
                return a = c(a), b[a] || (b[a] = d(a))
            }
            ...
            return function (a, b) {
                var d, e, c = arguments;
                if (2 == c.length)
                    for (d in b) e = b[d], void 0 !== e && b.hasOwnProperty(d) && f(a, d, e);
                else f(a, c[1], c[2])
            }
        }(), a
});
    ...
    if (window.addEventListener) {
        var b = window.StyleFix = {
            link: function (a) {
                ...
                var k, d = a.href || a.getAttribute("data-href"),
                    e = d.replace(/[^\/]+$/, ""),
                    f = (/^[a-z]{3,10}:/.exec(e) || [""])[0],
                    g = (/^[a-z]{3,10}:\/\/[^\/]+/.exec(e) || [""])[0],
                    h = /^([^?]*)\??/.exec(d)[1],
                ...
                j.onreadystatechange = function () {
                    ...
                    }), d = e.replace(/([\\\^\$*+[\]?{}.=!:(|)])/g, "\\$1"), c = c.replace(RegExp("\\b(behavior:\\s*?url\\('?\"?)" + d, "gi"), "$1")), d = document.createElement("style"), d.textContent = c, d.media = a.media, d.disabled = a.disabled, d.setAttribute("data-href", a.getAttribute("href")), i.insertBefore(d, a), i.removeChild(a), d.media = a.media)
                };
                try {
                    j.open("GET", d), j.send(null)
                } catch (l) {
                    "undefined" != typeof XDomainRequest && (j = new XDomainRequest, j.onerror = j.onprogress = function () {}, j.onload = k, j.open("GET", d), j.send(null))
                }
    ...
    if (window.StyleFix && window.getComputedStyle) {
        ...
        ! function () {
            ...
            if (0 < d.length)
                ...
                for (h in d) f(StyleFix.deCamelCase(h));
            g = 0;
        ...
        function () {
            ...
            c.selectors = [], c.atrules = [], f = a.appendChild(document.createElement("style"));
            for (g in d) h = g + (d[g] ? "(" + d[g] + ")" : ""), !b(h) && b(c.prefixSelector(h)) && c.selectors.push(g);
            for (i in e) h = i + " " + (e[i] || ""), !b("@" + h) && b("@" + c.prefix + h) && c.atrules.push(i);
            a.removeChild(f)
